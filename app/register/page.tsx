  ...
  return (
    <div className="grid min-h-screen place-items-center px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <Card className="p-6">
          <Badge tone="green">New Pilot</Badge>
          <h1 className="mt-4 text-2xl font-semibold text-zinc-50">Create account</h1>
          <p className="mt-2 text-sm leading-6 text-zinc-400">Register to save latency history and compare route quality over time.</p>
